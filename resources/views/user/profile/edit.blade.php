<x-layouts.app>
    ...
    "csv": {
      ...
      "class": "shrink-0 size-5"
                                    ...
                                    <div class="cursor-pointer p-12 flex justify-center bg-white border border-dashed border-gray-300 rounded-xl dark:bg-neutral-800 dark:border-neutral-600"
                                        ...
                                        <div class="text-center">
                                            <span class="inline-flex justify-center items-center size-16">
                                                <svg class="shrink-0 w-16 h-auto" width="71" height="51"
                                                    viewBox="0 0 71 51" fill="none"
                                                    ...
                                                    <g filter="url(#filter1)">
                                                        <rect x="17.5656" y="1" width="35.8689" height="42.7541"
                                                            rx="5" stroke="#2563EB" stroke-width="2"
                                                    ...
                                                    <defs>
                                                        <filter id="filter1" x="13.5656" y="0" width="43.8689"
                                                            height="50.7541" filterUnits="userSpaceOnUse"
                            ...
                            <!-- form group -->
                            <x-form.group for="email" label="Email" id="email" name="email"
                                type="email" />
                            <!-- end form group -->
