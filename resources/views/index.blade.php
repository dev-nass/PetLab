<x-layouts.app>
        ...
        <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
                ...
                <div class="mt-7 grid gap-3 w-full sm:inline-flex">
                    <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-600 text-white hover:bg-green-700 focus:outline-hidden focus:bg-green-700 disabled:opacity-50 disabled:pointer-events-none"
                        href="#">
                        See a vet
    ...
    <div class="max-w-[85rem] mx-auto text-center py-15">
        <h1 class="text-4xl text-gray-800 dark:text-white font-bold lg:w-[25ch] mx-auto">
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <nav class="max-w-6xl mx-auto flex flex-col sm:flex-row gap-y-px sm:gap-y-0 sm:gap-x-4" aria-label="Tabs"
            ...
            <button type="button"
                ...
                <svg class="shrink-0 hidden sm:block size-7 hs-tab-active:text-green-600 text-gray-800 dark:hs-tab-active:text-green-500 dark:text-white"
                ...
                <span class="sm:mt-5">
                    <span
                        class="hs-tab-active:text-green-600 block font-semibold text-gray-800 dark:hs-tab-active:text-green-500 dark:text-neutral-200">Choose
                        the perfect vet for your pet</span>
                    <span class="hidden lg:block mt-2 text-gray-800 dark:text-neutral-200">Explore vet profiles and see
                        reviews from fellow pet
                        parents.</span>
                </span>
            </button>
            ...
            <button type="button"
                ...
                <span class="sm:mt-5">
                    <span
                        class="hs-tab-active:text-green-600 block font-semibold text-gray-800 dark:hs-tab-active:text-green-500 dark:text-neutral-200">Get
                        expert pet care anytime</span>
                    <span class="hidden lg:block mt-2 text-gray-800 dark:text-neutral-200">Message a veterinarian
                        instantly or schedule a video
            ...
            <button type="button"
                ...
                <span class="sm:mt-5">
                    <span
                        class="hs-tab-active:text-green-600 block font-semibold text-gray-800 dark:hs-tab-active:text-green-500 dark:text-neutral-200">Keep
                        your pet’s health records safe</span>
                    <span class="hidden lg:block mt-2 text-gray-800 dark:text-neutral-200">Access your pet’s complete
                        medical history and
    ...
    <!-- Section 4 -->
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <h1 class="text-3xl text-gray-800 text-center font-bold lg:w-[28ch] mx-auto dark:text-white">
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="grid gap-12">
                ...
                <div class="grid lg:grid-cols-3 space-y-6 lg:space-y-10 lg:space-x-8">
                    <!-- Icon Block -->
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="max-w-5xl px-4 xl:px-0 py-10 lg:pt-10 lg:pb-20 mx-auto">
            ...
            <div class="max-w-3xl mb-10 lg:mb-14">
                <h2 class="text-gray-800 dark:text-white font-semibold text-2xl md:text-4xl md:leading-tight">
                    Our approach
                </h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 lg:items-center">
                ...
                <div>
                    <!-- Heading -->
                    <div class="mb-4">
                        <h3 class="text-green-500 text-xs font-semibold uppercase">
                            Steps
                        </h3>
                    </div>
                    <!-- End Heading -->
                    ...
                    <div class="flex gap-x-5 ms-1">
                        ...
                        <div class="grow pt-0.5 pb-8 sm:pb-12">
                            <p class="text-sm lg:text-base text-neutral-400">
                                <span class="text-gray-800 dark:text-white">Create Your Pet Lab Account:</span>
                    ...
                    <div class="flex gap-x-5 ms-1">
                        ...
                        <div class="grow pt-0.5 pb-8 sm:pb-12">
                            <p class="text-sm lg:text-base text-neutral-400">
                                <span class="text-gray-800 dark:text-white">Browse Trusted Veterinarians:</span>
                    ...
                    <div class="flex gap-x-5 ms-1">
                        ...
                        <div class="grow pt-0.5 pb-8 sm:pb-12">
                            <p class="text-sm md:text-base text-neutral-400">
                                <span class="text-gray-800 dark:text-white">Book Your Appointment:</span>
                    ...
                    <div class="flex gap-x-5 ms-1">
                        ...
                        <div class="grow pt-0.5 pb-8 sm:pb-12">
                            <p class="text-sm md:text-base text-neutral-400">
                                <span class="text-gray-800 dark:text-white">Enjoy Happy, Healthy Pets:</span>
                    ...
                    <a class="group inline-flex items-center gap-x-2 py-2 px-3 bg-green-600 font-medium text-sm text-neutral-800 rounded-full focus:outline-hidden"
                        href="#">
