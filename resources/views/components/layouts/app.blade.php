...
<body class="bg-neutral-900">
    <!-- ========== HEADER ========== -->
    <header
        class="sticky top-4 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full before:absolute before:inset-0 before:max-w-5xl before:mx-2 lg:before:mx-auto before:rounded-[26px] before:bg-neutral-700/30 before:backdrop-blur-md">
        <nav
            ...
            <div class="md:order-3 flex items-center gap-x-3">
                <div class="md:ps-3">
                    <a class="group inline-flex items-center gap-x-2 py-2 px-3 bg-green-500 font-medium text-sm text-nowrap text-neutral-800 rounded-full focus:outline-hidden"
                        href="#">
                        Sign In
                    </a>
                </div>
                                        ...
                                        <ul class="flex flex-col">
                                            <li
                                                ...
                                                <a class="group flex items-center gap-x-2 font-medium text-sm text-neutral-200 hover:text-[#ff0] focus:text-[#ff0] focus:outline-hidden"
                                                    ...
                                                    Websites
                                                    <span
                                                        class="ms-auto size-6 flex shrink-0 justify-center items-center">
                                                        <svg class="shrink-0 size-4 transition group-hover:translate-x-0.5 group-focus:translate-x-0.5"
                                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
